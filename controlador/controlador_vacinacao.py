...
class ControladorVacinacao:
    ...
    def abre_tela(self):
        opcoes = {1: self.incluir_vacinacao, 2: self.listar_vacinacao, 3: self.mostrar_vacinacao_paciente,
                  4: self.retornar_sistema}
        while True:
            button, values = self.__tela_menu_vacinacao.mostra_opcoes()
    ...
    def mostrar_vacinacao_paciente(self):
        ...
        self.__vacinacao_dao.get(paciente.cpf)
    ...
    def incluir_vacinacao(self):
        ...
        if paciente.dose == 0:
            tipo_dose = self.__controlador_estoque.estoques_disponiveis()
            print(tipo_dose)
