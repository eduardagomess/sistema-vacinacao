...
:pushpin: <b> Objetivo <b>: implementar um sistema orientado a objetos em Python para o controle de agendamento de vacinação.

:pushpin: <b> Escopo <b>: Cada posto de vacinação possui um estoque de vacinas de variados fabricantes, enfermeiros e enfermeiras responsáveis pela aplicação das
